...
from .views import BlogViewSet, BlogCommentViewSet, BlogCategoryViewSet, BlogAdViewSet, upload_blog_image
...
router.register(r'ads', BlogAdViewSet, basename='blog-ad')
